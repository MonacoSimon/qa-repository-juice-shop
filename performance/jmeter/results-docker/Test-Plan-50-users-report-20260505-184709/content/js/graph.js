...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 1.0, "minX": 1.77801762E12, "maxY": 2.2653061224489806, "series": [{"data": [[1.77801768E12, 1.0], [1.77801762E12, 2.2653061224489806]], "isOverall": false, "label": "Thread Group", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.77801768E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 1.0, "minX": 1.0, "maxY": 2.0714285714285716, "series": [{"data": [[2.0, 2.0714285714285716], [1.0, 1.5454545454545454], [4.0, 1.0], [3.0, 1.3225806451612905]], "isOverall": false, "label": "HTTP Request", "isController": false}, {"data": [[2.240000000000001, 1.76]], "isOverall": false, "label": "HTTP Request-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 4.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var bytesThroughputOverTimeInfos = {
        data : {"result": {"minY": 0.0, "minX": 1.77801762E12, "maxY": 4365.9, "series": [{"data": [[1.77801768E12, 89.1], [1.77801762E12, 4365.9]], "isOverall": false, "label": "Bytes received per second", "isController": false}, {"data": [[1.77801768E12, 0.0], [1.77801762E12, 0.0]], "isOverall": false, "label": "Bytes sent per second", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.77801768E12, "title": "Bytes Throughput Over Time"}},
        getOptions : function(){
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 1.7551020408163265, "minX": 1.77801762E12, "maxY": 2.0, "series": [{"data": [[1.77801768E12, 2.0], [1.77801762E12, 1.7551020408163265]], "isOverall": false, "label": "HTTP Request", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.77801768E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.77801762E12, "maxY": 4.9E-324, "series": [{"data": [[1.77801768E12, 0.0], [1.77801762E12, 0.0]], "isOverall": false, "label": "HTTP Request", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.77801768E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 1.6632653061224496, "minX": 1.77801762E12, "maxY": 2.0, "series": [{"data": [[1.77801768E12, 2.0], [1.77801762E12, 1.6632653061224496]], "isOverall": false, "label": "HTTP Request", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.77801768E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimeVsRequestInfos = {
    data: {"result": {"minY": 1.0, "minX": 1.0, "maxY": 2.0, "series": [{"data": [[2.0, 2.0], [1.0, 1.5], [4.0, 1.0], [5.0, 1.0], [3.0, 1.0]], "isOverall": false, "label": "Failures", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 5.0, "title": "Response Time Vs Request"}},
    getOptions: function() {
        return {
            series: {
                lines: {
...
var latenciesVsRequestInfos = {
    data: {"result": {"minY": 0.0, "minX": 1.0, "maxY": 4.9E-324, "series": [{"data": [[2.0, 0.0], [1.0, 0.0], [4.0, 0.0], [5.0, 0.0], [3.0, 0.0]], "isOverall": false, "label": "Failures", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 5.0, "title": "Latencies Vs Request"}},
    getOptions: function() {
        return{
            series: {
                lines: {
...
var hitsPerSecondInfos = {
        data: {"result": {"minY": 0.03333333333333333, "minX": 1.77801762E12, "maxY": 1.6333333333333333, "series": [{"data": [[1.77801768E12, 0.03333333333333333], [1.77801762E12, 1.6333333333333333]], "isOverall": false, "label": "hitsPerSecond", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.77801768E12, "title": "Hits Per Second"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var codesPerSecondInfos = {
        data: {"result": {"minY": 0.03333333333333333, "minX": 1.77801762E12, "maxY": 1.6333333333333333, "series": [{"data": [[1.77801768E12, 0.03333333333333333], [1.77801762E12, 1.6333333333333333]], "isOverall": false, "label": "Non HTTP response code: org.apache.http.conn.HttpHostConnectException", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.77801768E12, "title": "Codes Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var transactionsPerSecondInfos = {
        data: {"result": {"minY": 0.03333333333333333, "minX": 1.77801762E12, "maxY": 1.6333333333333333, "series": [{"data": [[1.77801768E12, 0.03333333333333333], [1.77801762E12, 1.6333333333333333]], "isOverall": false, "label": "HTTP Request-failure", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.77801768E12, "title": "Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var totalTPSInfos = {
        data: {"result": {"minY": 0.03333333333333333, "minX": 1.77801762E12, "maxY": 1.6333333333333333, "series": [{"data": [], "isOverall": false, "label": "Transaction-success", "isController": false}, {"data": [[1.77801768E12, 0.03333333333333333], [1.77801762E12, 1.6333333333333333]], "isOverall": false, "label": "Transaction-failure", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.77801768E12, "title": "Total Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
